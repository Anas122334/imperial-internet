<?php
$title = "The guidelines, terms & conditions of the Imperial Internet   ";
$description = "Imperial Terms & Conditions is a crucial document that details the obligations customers accept when using an IRG service or product.";
include("include/header.php") ?>

<div class="container pt-5 pb-4">
    <h1 class="text-center" style="color: #535353;">Terms and Conditions</h1>
</div>

<div class="container mt-5">
    <h4>1. Terms and Conditions</h4>
    <p class="mt-3">1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Imperial Technologies Inc., doing business as Imperial Internet and Imperial Wireless, located at <a href="https://www.google.com/maps/place/1305+Hardeman+Ave,+Macon,+GA+31201,+USA/@32.8398672,-83.6407867,17z/data=!3m1!4b1!4m6!3m5!1s0x88f3fe8f37f0e049:0x131517c4e56f6e20!8m2!3d32.8398672!4d-83.6407867!16s%2Fg%2F11bz_18bbl?entry=ttu" class="text-decoration-none text-dark fw-bold">869 Walnut Street Macon, GA 31201, Macon, United States</a> (we, us), concerning your access to and use of the Imperial Technologies Inc. <a href="index.php" class="text-decoration-none text-dark fw-bold">(https://www.imperialinternet.com)</a> website as well as any related applications (the Site).</p>
    <p class="">You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
    <p class="">1.2 The supplemental policies set out in Section 1.7 below, as well as any supplemental terms and condition or documents that may be posted on the Site from time to time, are expressly incorporated by reference.</p>
    <p class="">1.3 We may make changes to these Terms and Conditions at any time. The updated version of these Terms and Conditions will be indicated by an updated “Revised” date and the updated version will be effective as soon as it is accessible. You are responsible for reviewing these Terms and Conditions to stay informed of updates. Your continued use of the Site represents that you have accepted such changes.</p>
    <p class="">1.4 We may update or change the Site from time to time to reflect changes to our products, our users' needs and/or our business priorities.</p>
    <p class="">1.5 Our site is directed to people residing in the United States. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.</p>
    <p class="">1.6 The Site is intended for users who are at least 18 years old. If you are under the age of 18, you are not permitted to register for the Site or use the Services without parental permission.</p>
    ...
    <h4 class="mt-4">2. Acceptable Use</h4>
    <p class="mt-3">2.1 Our full Acceptable Use Policy , sets out all the permitted uses and prohibited uses of this site.</p>
    ...
    <h4 class="mt-4">3. Our Content</h4>
    <p class="mt-3">3.1 Unless otherwise indicated, the Site and Services including source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (Our Content) are owned or licensed to us, and are protected by copyright and trade mark laws.</p>
    ...
    <p>3.3 Provided that you are eligible to use the Site, you are granted a limited license to access and use the Site and Our Content and to download or print a copy of any portion of the Content to which you have properly gained access solely for your personal, non-commercial use.</p>
    <p>3.4 You shall not (a) try to gain unauthorized access to the Site or any networks, servers or computer systems connected to the Site; and/or (b) make for any purpose including error correction, any modifications, adaptions, additions or enhancements to the Site or Our Content, including the modification of the paper or digital copies you may have downloaded.</p>
    ...
    <h4 class="mt-4">5. Modifications to and availability of the Site</h4>
    <p class="mt-3">5.1 We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. We also reserve the right to modify or discontinue all or part of the Services without notice at any time.</p>
    ...
    <p class="fw-bold">Whether you are a consumer or a business user:</p>
    <ul>
    ...
    <p class="fw-bold">If you are a business user:</p>
    ...
    <ul class="lh-lg">
        ...
        <li>use of or reliance on any content displayed on our Si</li>
    </ul>
    ...
    <p class="fw-bold">If you are a consumer user:</p>
    <ul class="lh-lg">
    ...
    <h4 class="mt-4">7. Term and Termination</h4>
    <p>7.1 These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at <a href="matilto:info@imperialinternet.com" class=" text-dark">info@imperialinternet.com</a>.</p>
    ...
    <p>8.9 In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at <a href="mailto:info@imperialinternet.com" class="text-dark">info@imperialinternet.com</a> or by post to:</p>
    <ul class="p-0 fw-bold lh-lg" style="list-style: none;">
        <li>Imperial Technologies Inc.</li>
        <li><a href=""></a>869 Walnut St Macon, GA 31201 United States</li>
        <li><a href="tel:1 (800)-660-2639" class="text-decoration-none text-dark">1 (800)-660-2639</a< /li>
        <li><a href="mailto:info@imperialinternet.com" class="text-decoration-none text-dark">info@imperialinternet.com</a></li>
    </ul>
</div>
