            ...
            <form class="row g-3">
                <div class="row">
                    <div class=" col-12 col-md-5 col-sm-12">
                        <label for="currentpassword" class="form-label fw-bold">Enter Current Password:</label>
                        <input type="password" class="form-control bg-light" id="currentpassword">
                    </div>
                </div>
                <div class="col-12 col-md-5 col-sm-12">
                ...
                <div class="col-12">
                    <a href="forget-password.php" class="text-decoration-none text-black-50">Forget Password?</a>
                </div>
                <div class="col-12">
